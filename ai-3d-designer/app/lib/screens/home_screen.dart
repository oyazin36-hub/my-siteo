...
/// Phase 0 の画面。サーバー疎通とログインが成立しているかを確認するためのもの。
/// Phase 1 でこの画面は「新規作成 / 過去作品 / 設定」のホーム画面に置き換わる。
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('AI 3D Product Designer')),
      body: RefreshIndicator(
        onRefresh: _runConnectionCheck,
        child: ListView(
          padding: const EdgeInsets.all(16),
          children: [
            Text('Phase 0 — 疎通確認', style: Theme.of(context).textTheme.titleLarge),
